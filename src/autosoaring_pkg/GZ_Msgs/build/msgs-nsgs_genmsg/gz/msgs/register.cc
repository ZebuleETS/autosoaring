...
namespace {
  ...
  {"gz.msgs.Thermal",
    []()->std::unique_ptr<google::protobuf::Message>{return std::make_unique<gz::msgs::Thermal>();}},
  {"gz.msgs.ThermalGroup",
    []()->std::unique_ptr<google::protobuf::Message>{return std::make_unique<gz::msgs::ThermalGroup>();}},
}};
}  // namespace
